function Parameters = Geometry()
    ...
    Parameters.Rc_h1 = 0.256555198924927;       % Raggio hub del compressore
    Parameters.Rc_t = 0.513110397849855;        % Raggio tip del compressore
    Parameters.Rc_he = 0.478165999743676;       %  Raggio finale dell'hub
end